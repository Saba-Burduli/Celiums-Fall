...
local function silhouette(y, color, speed, time)
  ...
  love.graphics.polygon("fill", 0, 720, 0, y, 180 + shift, y - 95, 340 + shift, y,
    520 + shift, y - 135, 710 + shift, y, 900 + shift, y - 105, 1080 + shift, y, 1280, y - 80, 1280, 720)
end

function Cinematic.draw(game)
  local current = game.cinematic
  if not current then return end
  font = font or love.graphics.newFont("assets/fonts/kenpixel-square.ttf", 18)
  love.graphics.setColor(.008, .006, .018, .96); love.graphics.rectangle("fill", 0, 0, 1280, 720)
